...
docker exec cli peer chaincode instantiate -o $ORDERER_ENDPOINT --tls --cafile $ORDERER_CA -C $CHANNEL_NAME -c '{"Args":["init"]}' -n $CHAINCODE_NAME -v $CHAINCODE_VERSION -P "OR ('Org1MSP.member', 'Org2MSP.member')"